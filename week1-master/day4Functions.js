...
// 1. Let's a function called speak that takes in a single parameter called item, and logs that item to the console.
  ...
  // Which part of this is the function body? the console.log is the function body
  // What is the parameter name? the parameter is item
  // Is this function a return value function, or a side effect function? it is a neither
  // What happens if we change console.log(item) to have quotes around item, like console.log('item') ? it changes the variable item to a sting and prints out item
...
var speak = function(val) {
    console.log('item is set equal to what the user passed into us:', val);
  }; speak('val');
...
var climbHalfDome = function() {
  console.log( "Yay, congrats on climbing such an awesome rock!")
}; climbHalfDome();
...
var add5Return = function(number) {
  return number + 5;
}; add5Return(2);
...
// 9. Create a variable called add5SideEffect that takes in no parameters, and doesn't return anything. Instead, this function will have a side effect by adding 5 to sideEffectResults. 
  ...
  var add5SideEffect = function() {
     sideEffectResults += 5;
  }; console.log(add5SideEffect());
  console.log(sideEffectResults);
  var sideEffectReturn = add5SideEffect(); //undefined
// 10. Discuss with your partner what a side effect is vs. a returned value. 
 ...
 // = the value of a functiong is whatever it returns;
...
// 12. Let's create a function called superPowerAdder, that does a few things:
  ...
  function superPowerAdder(object) {
    object.superPower = "JS ninja-ing";
    return object;
  };
...
for ( var i = 0; i < grandCouncil.length; i++) {
    if(typeof grandCouncil[i] === "object"){
       console.log(superPowerAdder(grandCouncil[i]));
     }
   }
// function superPowerAdder(object){
//   object.superPower = 'JS ninja-ing';
...
// for(var i = 0; i < grandCouncil.length; i++){
//     if(typeof grandCouncil[i] === Object && typeof grandCouncil !== String) {
...
var animalMaker = function(inputType, inputSuperPower, inputCanFly) {
