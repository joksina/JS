...
console.log(mysticalAnimal.likes);
console.log(mysticalAnimal.bestFriend);
console.log(mysticalAnimal.superPower);
  // 'dragon'
  // 'Larry'
  // []
  // your own name
...
var newPropertyToAdd = {};
      newPropertyToAdd["sauce"] = "BBQ";
...
var me = {
  collects: "diamonds gold, and fire extinguishers"
}
